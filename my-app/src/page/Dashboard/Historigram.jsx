        ...
        try {
            ...
            if (dataJson.mode ==  "data") { 
                if (  !dataJson.hasOwnProperty('content')|| !dataJson.content.hasOwnProperty('nombre_pieces')) {console.error('Cant found content or nombre_pieces'); return ;}
                    ...
                    let  newdata = [];
                    const index =   state.dataColumns.findIndex(item => item.name === dataJson.content.reference_robot);
                    if (index !== -1) {
                        ...
                        newdata =  [...  state.dataColumns, {name:   dataJson.content.reference_robot, totalPiecesPalatize:   parseFloat( dataJson.content.nombre_pieces)}];
                    }
